...
class BinaryWatchPainter extends WatchPainter {
	...
	private void drawNumber(int x, int y,int binary1, int binary2, int binary3, int binary4){
		if (binary1 > 0){
			fillOval((int) ((30 + x) / fontSize), (int) (50 / fontSize) + 50,
					(int) (80 / fontSize), (int) (80 / fontSize));
		} else {
		drawClockCircle((int) ((30 + x) / fontSize),
				(int) (50 / fontSize) + 50, (int) (80 / fontSize),
				(int) (80 / fontSize));
		}
		if (binary2 > 0){
			fillOval((int) ((30 + x) / fontSize), (int) (120 / fontSize) + 50,
					(int) (80 / fontSize), (int) (80 / fontSize));
		} else {
		drawClockCircle((int) ((30 + x) / fontSize),
				(int) (120 / fontSize) + 50, (int) (80 / fontSize),
				(int) (80 / fontSize));
		}
		if (binary3 > 0) {
			fillOval((int) ((30 + x) / fontSize), (int) (190 / fontSize) + 50,
					(int) (80 / fontSize), (int) (80 / fontSize));
		} else {
		drawClockCircle((int) ((30 + x) / fontSize),
				(int) (190 / fontSize) + 50, (int) (80 / fontSize),
				(int) (80 / fontSize));
		}
		
		if (binary4 > 0) {
			fillOval((int) ((30 + x) / fontSize), (int) (260 / fontSize) + 50,
					(int) (80 / fontSize), (int) (80 / fontSize));
		} else {
			drawClockCircle((int) ((30 + x) / fontSize),
				(int) (260 / fontSize) + 50, (int) (80 / fontSize),
				(int) (80 / fontSize));
		}
	}
