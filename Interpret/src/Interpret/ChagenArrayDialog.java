...
class ChagenArrayDialog extends Dialog implements ActionListener {
	...
	public ChagenArrayDialog(Interpret owner, String dialogName,
			Class<?> type,Object arrayObj, Map clazz) {
		super(owner);
		this.owner = owner;
		this.type = type;
		this.clazz = clazz;
